...
const Introduction: React.FC<IntroductionProps> = ({ onStart }) => {
  ...
  return (
    <div className="text-center bg-slate-800/50 backdrop-blur-sm p-4 sm:p-6 md:p-8 rounded-2xl shadow-2xl border border-slate-700 animate-fade-in">
      ...
      <div className="text-start max-w-xl mx-auto space-y-3 sm:space-y-4 mb-8 sm:mb-10">
        <div className="flex items-start gap-3">
          <div className="text-[#8b959e] mt-1" aria-hidden="true">
            ✓
          </div>
          <p className="text-slate-300">
            <strong className="text-white">
              <FormattedMessage id="introduction.part1.title" />
            </strong>{' '}
        ...
        <div className="flex items-start gap-3">
          ...
          <p className="text-slate-300">
            <strong className="text-white">
              <FormattedMessage id="introduction.part2.title" />
            </strong>{' '}
        ...
        <div className="flex items-start gap-3">
          ...
          <p className="text-slate-300">
            <strong className="text-white">
              <FormattedMessage id="introduction.part3.title" />
            </strong>{' '}
