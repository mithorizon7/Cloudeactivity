...
const Summary: React.FC<SummaryProps> = ({ scores, onRestart }) => {
  ...
  const maxScore =
    maxScores.part1 + maxScores.part2 + maxScores.part3 + maxScores.part4 + maxScores.part5;

  return (
    <div className="text-center bg-slate-800/50 backdrop-blur-sm p-4 sm:p-6 md:p-8 rounded-2xl shadow-2xl border border-slate-700 animate-fade-in">
      <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3 sm:mb-4">
        <FormattedMessage id="summary.title" />
      </h1>
      <p className="text-base sm:text-lg text-slate-300 max-w-2xl mx-auto mb-4 sm:mb-6">
        <FormattedMessage id="summary.description" />
      </p>

      <div className="text-start max-w-2xl mx-auto space-y-3 sm:space-y-4 mb-6 sm:mb-8 bg-slate-900/50 p-4 sm:p-6 rounded-lg">
        <p className="text-slate-300">
          <strong className="text-[#ba7f89]">
            <FormattedMessage id="summary.recap.foundations.title" />
          </strong>{' '}
          <FormattedMessage id="summary.recap.foundations.text" />
        </p>
        <p className="text-slate-300">
          <strong className="text-[#ba7f89]">
            <FormattedMessage id="summary.recap.servicemodels.title" />
          </strong>
        ...
        <p className="text-slate-300">
          <strong className="text-[#ba7f89]">
            <FormattedMessage id="summary.recap.deploymentmodels.title" />
          </strong>
          <span className="block" style={{ marginInlineStart: '1rem' }}>
        ...
        <p className="text-slate-300">
          <strong className="text-[#ba7f89]">
            <FormattedMessage id="summary.recap.perspective.title" />
          </strong>{' '}
          <FormattedMessage id="summary.recap.perspective.text" />
        </p>
        <p className="text-slate-300">
          <strong className="text-[#ba7f89]">
            <FormattedMessage id="summary.recap.application.title" />
          </strong>{' '}
